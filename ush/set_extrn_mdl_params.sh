...
case "${EXTRN_MDL_NAME_LBCS}" in
  ...
  "FV3GFS")
    ...
    ;;
  "GEFS")
    EXTRN_MDL_LBCS_OFFSET_HRS="${EXTRN_MDL_LBCS_OFFSET_HRS:-6}"
    ;;
  "RAP")
...
case "${EXTRN_MDL_NAME_ICS}" in
  "GSMGFS")
    EXTRN_MDL_ICS_OFFSET_HRS="${EXTRN_MDL_ICS_OFFSET_HRS:-0}"
    ;;
  "FV3GFS")
    EXTRN_MDL_ICS_OFFSET_HRS="${EXTRN_MDL_ICS_OFFSET_HRS:-0}"
    ;;
  "GEFS")
    EXTRN_MDL_ICS_OFFSET_HRS="${EXTRN_MDL_ICS_OFFSET_HRS:-6}"
    ;;
  "RAP")
    EXTRN_MDL_ICS_OFFSET_HRS="${EXTRN_MDL_ICS_OFFSET_HRS:-3}"
    ;;
  "HRRR")
    EXTRN_MDL_ICS_OFFSET_HRS="${EXTRN_MDL_ICS_OFFSET_HRS:-0}"
    ;;
